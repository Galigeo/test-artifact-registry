...
```
starting build "0e1f9b29-ac24-4e4b-8278-39ffef062142"
...
Step #0 - "fetch": Fetching manifest gs://staging.retail-poi-service.appspot.com/ae/f3a651eb-aedf-4cd9-81be-8a4ead8c72d1/manifest.json.
Step #0 - "fetch": Processing 16 files.
Step #0 - "fetch": ******************************************************
Step #0 - "fetch": Status:                      SUCCESS
Step #0 - "fetch": Started:                     2023-06-23T12:58:43Z
Step #0 - "fetch": Completed:                   2023-06-23T12:58:43Z
...
Step #0 - "fetch": MiB downloaded:         0.11 MiB
Step #0 - "fetch": MiB/s throughput:       1.68 MiB/s
Step #0 - "fetch": Time for manifest:     83.94 ms
Step #0 - "fetch": Total time:             0.15 s
Step #0 - "fetch": ******************************************************
...
Step #1 - "pre-buildpack": Retagging eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest as eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:0e1f9b29-ac24-4e4b-8278-39ffef062142
...
Step #1 - "pre-buildpack": DEBUG: "eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest"(eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest) took 258.523834ms
...
Step #1 - "pre-buildpack": DEBUG: ...pull("eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest") took 267.487639ms
Step #1 - "pre-buildpack": DEBUG: ...validate("eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest") took 126.90404ms
Step #1 - "pre-buildpack": Image eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest is valid
Step #1 - "pre-buildpack": DEBUG: "eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest"(eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest) took 394.47529ms
Step #1 - "pre-buildpack": Image eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest copied to eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:0e1f9b29-ac24-4e4b-8278-39ffef062142
Step #1 - "pre-buildpack": DEBUG: "eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest", "eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:0e1f9b29-ac24-4e4b-8278-39ffef062142"(eu.gcr.io/retail-poi-service/app-engine-tmp/build-cache/default/ttl-7d:latest) took 1.361750093s
...
Step #2 - "build": 1a727546856e: Verifying Checksum
Step #2 - "build": 1a727546856e: Download complete
Step #2 - "build": 4df74b81db3a: Pull complete
Step #2 - "build": e0c603388230: Verifying Checksum
...
Step #2 - "build": Image with name "eu.gcr.io/retail-poi-service/app-engine-tmp/app/default/ttl-18h:f3a651eb-aedf-4cd9-81be-8a4ead8c72d1" not found
...
Step #2 - "build": 2023/06/23 12:59:02 [DEBUG] GET https://dl.google.com/runtimes/ubuntu1804/nodejs/nodejs-14.21.3.tar.gz
...
Step #2 - "build": Done "node -v" (59.670631ms)
Step #2 - "build": DEBUG: Current dependency hash: "bf5023efa662563378a180b9d5fd81bc5ec82933e2170f1e9c83556edbaaf45f"
...
Step #2 - "build": Running "node -v"
Step #2 - "build": v14.21.3
Step #2 - "build": Done "node -v" (9.573621ms)
Step #2 - "build": --------------------------------------------------------------------------------
Step #2 - "build": Running "npm --version"
Step #2 - "build": 6.14.18
Step #2 - "build": Done "npm --version" (231.110735ms)
Step #2 - "build": --------------------------------------------------------------------------------
Step #2 - "build": Running "npm ci --quiet (NODE_ENV=development)"
Step #2 - "build": npm ERR! Cannot read property '@galigeo-store/shared-models' of undefined
Step #2 - "build": 
Step #2 - "build": npm ERR! A complete log of this run can be found in:
Step #2 - "build": npm ERR!     /www-data-home/.npm/_logs/2023-06-23T12_59_06_481Z-debug.log
Step #2 - "build": Done "npm ci --quiet (NODE_ENV=development)" (714.199575ms)
Step #2 - "build": Failure: (ID: beaf8772) npm ERR! Cannot read property '@galigeo-store/shared-models' of undefined
Step #2 - "build": 
Step #2 - "build": npm ERR! A complete log of this run can be found in:
Step #2 - "build": npm ERR!     /www-data-home/.npm/_logs/2023-06-23T12_59_06_481Z-debug.log
Step #2 - "build": --------------------------------------------------------------------------------
Step #2 - "build": Running "mv -f /builder/outputs/output-3650786760520319707 /builder/outputs/output"
Step #2 - "build": Done "mv -f /builder/outputs/output-3650786760520319707 /builder/o..." (52.460474ms)
